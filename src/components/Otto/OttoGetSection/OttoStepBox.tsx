    ...
    case 1:
      return (
        <div className={classes.image}>
          <Image src={ImageStep1} alt="step1" placeholder="blur" priority />
        </div>
      )
    case 2:
      return (
        <div className={classes.image}>
          <Image src={ImageStep2} alt="step2" placeholder="blur" priority />
        </div>
      )
    case 3:
      return (
        <div className={classes.image}>
          <Image src={ImageStep3} alt="step3" placeholder="blur" priority />
        </div>
      )
    default:
      return <></>
