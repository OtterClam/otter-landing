...
const GetStartedView = () => {
  ...
  return (
    <StyledContainer>
      <Title>
        <CustomH1>{t('getStarted.title')}</CustomH1>
        <h3>{t('getStarted.subtitle')}</h3>
      </Title>
      <ContentCard>
        <p>{t('getStarted.paragraph1')}</p>
        <Divider />
        <h3>{t('getStarted.paragraph2.title')}</h3>
        <p>{t('getStarted.paragraph2.content')}</p>
        <ImageContainer>
          <Image src={ImageMatic2Clam.src} width={162} height={74} layout="intrinsic" alt="Matic to Clam" />
        </ImageContainer>
        <p>
        ...
        <p>
          ...
          some for gas), you can simply stake your CLAM to start earning rewards. Go here to stake.{' '}
        </p>
        <ImageContainer>
          <Image src={ImageClam2SClam.src} width={162} height={74} layout="intrinsic" alt="Clam to sClam" />
        </ImageContainer>
        <p>
        ...
        <ImageContainer>
          <Image src={ImageClam2Pearl.src} width={270} height={74} layout="intrinsic" alt="Clam to Pearl" />
        </ImageContainer>
        <p>
        ...
        <h3>PEARL Chests</h3>
        <ImageContainer>
          <Image src={ImagePearl2Chest.src} width={182} height={74} layout="intrinsic" alt="Pearl to Chest" />
        </ImageContainer>
        <p>
          ...
          this sounds great to you, but you’d like a little more information, go here to get better acquainted with
          PEARL chests. If you’ve already thought about it, and you’re ready to lock up your PEARLs, go here.
        </p>
        <Divider />
        <h3>Bond</h3>
        <p>
        ...
        <ImageContainer>
          <Image src={ImageBond2SClam.src} width={162} height={74} layout="intrinsic" alt="Bond to sClam" />
        </ImageContainer>
        <p>
          Now, we have (4,4) bonds that allow you to enjoy rewards from the time you bond until it’s time to claim your
          CLAM 5 days later. While bonding is a great way to get discounted CLAM at certain times, unstaking your
          previously purchased CLAM to bond is detrimental to the protocol, and ultimately detrimental to all Otters, so
          we recommend bonding with assets upon arrival to the kingdom. To learn more about bonding and the bonding
          pairs we currently offer, go here.
        </p>
      </ContentCard>
    </StyledContainer>
  )
