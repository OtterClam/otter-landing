  ...
  return (
    <StyledContainer>
      ...
      <ContentCard>
        ...
        <h3>Buy CLAMs</h3>
        <p>
          You’ll need to program your MetaMask wallet to read Polygon first.
          Once you’ve done that, use native MATIC to swap for CLAM on Quickswap,
          Polygon’s largest DeFi exchange. The MATIC/CLAM pair is likely the
          easiest if you’ve just arrived on Polygon, but you can swap several
          other assets for CLAM as well.
        </p>
        <ImageContainer>
          <Image
            src={ImageMatic2Clam.src}
            width={162}
            height={74}
            layout="intrinsic"
            alt="Matic to Clam"
        ...
        <p>
          ...
          <a
            href="https://hackmd.io/G4NdFuxLQiO8Oannby5WzQ"
            target="_blank"
            rel="noreferrer"
          >
            this tutorial
        ...
        <p>
          This is the most basic way to take advantage of holding CLAM. Staking
          is immediate and you can unstake anytime you like. Maximum
          flexibility, maximum convenience. For those of you interested in
          increasing your CLAM returns, read on.{' '}
        </p>
        <Divider />
        <h3>Convert to PEARL</h3>
        <p>
          Converting your sCLAM to PEARL requires “wrapping.” Wrapping your
          sCLAM ensures you receive sCLAM rebase rewards, but it also opens up a
          new tier of investment potential.
        </p>
        <ImageContainer>
          <Image
        ...
        <p>
          ...
          If treasure chests filled with PEARLS sound enticing to you, keep
          reading.
        </p>
        <h3>PEARL Chests</h3>
        <ImageContainer>
          <Image
            src={ImagePearl2Chest.src}
            width={182}
            height={74}
            layout="intrinsic"
            alt="Pearl to Chest"
        ...
        <p>
          The Otter Kingdom has a huge vault deep below the riverbed containing
          countless chests ready to secure your PEARLs. The protocol is designed
          to offer you exceptionally high APYs for trusting us with your PEARL.
          The terms for these chests vary from 14 to 180 days. The longer you’re
          willing to lock up your PEARL, the larger the share of each reward
          rebase we’re willing to offer you.
          <br />
          <br />
        ...
        <h3>Bond</h3>
        <p>
          Bonding is an easy way for you to get CLAM at a discount, and you may
          be able to use a few other assets you already have. Basically, by
          committing to a 5-day bond, OtterClam is able to provide a discount to
          you when the protocol needs liquidity for certain assets.
        </p>
        <ImageContainer>
          <Image
